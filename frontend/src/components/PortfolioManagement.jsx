...
const PortfolioManagement = () => {
  ...
  const confirmDeletePortfolio = async () => {
    ...
    try {
      setDeletingPortfolio(portfolioToDelete.id);
      await authAxios.delete(`/api/portfolios/${portfolioToDelete.id}`);

      setSuccessMessage('포트폴리오가 삭제되었습니다.');
      setTimeout(() => setSuccessMessage(null), 3000);

      // 삭제된 포트폴리오가 현재 선택된 포트폴리오인 경우 선택 해제
            ...
            {portfolios.map((portfolio) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-2 right-2 text-gray-400 hover:text-red-500 transition-colors p-1 hover:bg-red-50 rounded-lg"
                  title="포트폴리오 삭제"
                >
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 space-y-1">
                    <p>
                      현재: {(portfolio.totalAmount || 0).toLocaleString()}원
                    </p>
                    {/* 투자 성향 표시 */}
          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <span className="text-red-500 font-medium">
                이 작업은 되돌릴 수 없으며, 포트폴리오와 관련된 모든 종목
                데이터가 삭제됩니다.
              </span>
            </p>
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition-colors font-medium disabled:opacity-50 flex items-center justify-center"
              >
                {deletingPortfolio ? (
